...
const iconStyle =
  "text-secondary border-[1px] border-secondary p-2 hover:bg-primary hover:border-primary hover:text-[white] transition-all duration-700 hover:cursor-pointer rounded-full bg-[#27363a]";
...
const Footer = ({ footer_data }: IFooter) => {
  ...
  return (
    <div className="bg-dark text-[white]">
        ...
        <div className="grid lg:grid-cols-4 gap-20">
          <div className="flex flex-col gap-6">
            ...
            <Link href="/" className="flex items-center my-4 lg:col-span-2 ">
              <img
                src="https://wordpress.themeholy.com/tourm/wp-content/uploads/2024/07/logo-white.svg"
                alt=""
              />
              {/* <img
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="text-white flex flex-col gap-4">
              <div className="flex items-start  gap-1">
                <div>
                  <IoLocationSharp size={18} className="translate-y-1" />
                </div>
      ...
      <div className="border-t-[1px] rounded-full border-t-[gray]">
